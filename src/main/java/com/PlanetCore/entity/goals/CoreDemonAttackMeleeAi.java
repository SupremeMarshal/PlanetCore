...
public class CoreDemonAttackMeleeAi extends EntityAIBase {
        ...
        public CoreDemonAttackMeleeAi(EntityCoreDemon entityCoreDemon, double speedIn, boolean useLongMemory) {
