...
public class OnyxDemonAttackMeleeAi extends EntityAIBase {
        ...
        public OnyxDemonAttackMeleeAi(EntityOnyxDemon entityOnyxDemon, double speedIn, boolean useLongMemory) {
