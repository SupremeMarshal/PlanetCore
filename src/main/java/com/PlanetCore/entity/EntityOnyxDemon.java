...
public class EntityOnyxDemon extends EntityMob implements IAnimatable {
	...
	private static final DataParameter<Integer> TEXTURE = EntityDataManager.<Integer>createKey(EntityOnyxDemon.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> ATTACK_TICK = EntityDataManager.<Integer>createKey(EntityOnyxDemon.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> FLY_TICK = EntityDataManager.<Integer>createKey(EntityOnyxDemon.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> FIREBALL_TICK = EntityDataManager.<Integer>createKey(EntityOnyxDemon.class, DataSerializers.VARINT);
	...
	protected void initEntityAI () {
		this.tasks.addTask(5, new EntityOnyxDemon.AIRandomFly(this));
		this.tasks.addTask(3, new OnyxDemonAttackMeleeAi(this, 1.0, true));
		...
		this.tasks.addTask(3, new OnyxDemonFireBallGoal(this));
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(250D);
	...
	{
		private final EntityOnyxDemon parentEntity;

		public AIRandomFly(EntityOnyxDemon ghast)
		{
	...
	static class GhastMoveHelper extends EntityMoveHelper
	{
		...
		public GhastMoveHelper(EntityOnyxDemon ghast)
		{
			super(ghast);
			this.parentEntity = ghast;
		}
