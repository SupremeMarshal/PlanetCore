...
public class RenderOnyxFireball extends Render<EntityOnyxFireball>
{
    private final float scale;

    public RenderOnyxFireball(RenderManager renderManagerIn, float scaleIn)
    {
     ...
     */
    @Override
    public void doRender(EntityOnyxFireball entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(ModItems.ONYX_FIREBALL);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityOnyxFireball entity)
    {
