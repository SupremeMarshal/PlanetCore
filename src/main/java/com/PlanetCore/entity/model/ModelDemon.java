...
/**
 * ModelBehemoth - Either Mojang or a mod author
 * Created using Tabula 7.0.0
 */
public class ModelDemon extends ModelBase {
	public double[] modelScale = new double[] { 1.1D, 1.1D, 1.1D };
    ...
    public ModelDemon() {
        ...
        this.body.setRotationPoint(0.0F, -21.3F, -2.0F);
        this.body.addBox(-8.0F, 0.1F, -4.0F, 16, 11, 11, 0.0F);
        this.setRotateAngle(body, 0.1308996938995747F, 0.014486232791552934F, -0.027052603405912107F);
        ...
        this.leftleg.setRotationPoint(5.0F, 3.3F, 1.0F);
