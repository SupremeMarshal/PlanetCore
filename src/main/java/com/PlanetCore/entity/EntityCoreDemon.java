...
public class EntityCoreDemon extends EntityMob implements IAnimatable {
	...
	private static final DataParameter<Integer> TEXTURE = EntityDataManager.<Integer>createKey(EntityCoreDemon.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> ATTACK_TICK = EntityDataManager.<Integer>createKey(EntityCoreDemon.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> FLY_TICK = EntityDataManager.<Integer>createKey(EntityCoreDemon.class, DataSerializers.VARINT);
	private static final DataParameter<Integer> FIREBALL_TICK = EntityDataManager.<Integer>createKey(EntityCoreDemon.class, DataSerializers.VARINT);
	...
	{
		private final EntityCoreDemon parentEntity;

		public AIRandomFly(EntityCoreDemon ghast)
		{
	...
	static class GhastMoveHelper extends EntityMoveHelper
	{
		...
		public GhastMoveHelper(EntityCoreDemon ghast)
		{
			super(ghast);
			this.parentEntity = ghast;
		}
