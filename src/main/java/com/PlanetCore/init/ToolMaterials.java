...
public class ToolMaterials {
    ...
    public static final Item.ToolMaterial URANIUM = createToolMaterial("uranium", 4, 30, 120.0F, 9.4F, 22, 2.5F);
    public static final Item.ToolMaterial COMPLETE_URANIUM = createToolMaterial("complete_uranium", 4, 60, 120.0F, 9.4F, 22, 2.5F);
    public static final Item.ToolMaterial TUNGSTEN = createToolMaterial("tungsten", 4, 2000, 75.0F, 7.0F, 22, 2.5F);
    public static final Item.ToolMaterial COMPLETE_TUNGSTEN = createToolMaterial("complete_tungsten", 4, 4000, 75.0F, 7.0F, 22, 2.5F);
    public static final Item.ToolMaterial TITANIUM_URANIUM = createToolMaterial("titanium_uranium", 4, 1030, 170.0F, 12.0F, 22, 2.5F);
    public static final Item.ToolMaterial COMPLETE_TITANIUM_URANIUM = createToolMaterial("complete_titanium_uranium", 4, 2060, 170.0F, 12.0F, 22, 2.5F);
    public static final Item.ToolMaterial TUNGSTEN_URANIUM = createToolMaterial("tungsten_uranium", 4, 2030, 250.0F, 12.0F, 22, 2.5F);
    public static final Item.ToolMaterial COMPLETE_TUNGSTEN_URANIUM = createToolMaterial("complete_tungsten_uranium", 4, 4060, 250.0F, 12.0F, 22, 2.5F);
    public static final Item.ToolMaterial TUNGSTEN_TITANIUM = createToolMaterial("tungsten_titanium", 4, 3000, 380.0F, 9.0F, 22, 2.5F);
    public static final Item.ToolMaterial COMPLETE_TUNGSTEN_TITANIUM = createToolMaterial("complete_tungsten_titanium", 4, 6000, 380.0F, 9.0F, 22, 2.5F);
    public static final Item.ToolMaterial EMERALD = createToolMaterial("emerald", 5, 600, 1000.0F, 9.5F, 22, 3);
    public static final Item.ToolMaterial RUBY = createToolMaterial("ruby", 6, 900, 2000.0F, 10.0F, 22, 3);
    public static final Item.ToolMaterial SAPPHIRE = createToolMaterial("sapphire", 6, 1200, 3000.0F, 11.0F, 22, 3);
    public static final Item.ToolMaterial DIAMOND = createToolMaterial("diamond", 10, 2500, 5000.0F, 12.5F, 22, 3);
    public static final Item.ToolMaterial OLIVINE = createToolMaterial("olivine", 11, 1200, 7500.0F, 13.0F, 22, 3);
    public static final Item.ToolMaterial WADSLEYITE = createToolMaterial("wadsleyite", 12, 1200, 10000.0F, 13.5F, 22, 3);
    public static final Item.ToolMaterial RINGWOODITE = createToolMaterial("ringwoodite", 13, 1200, 15000.0F, 14.0F, 22, 3);
    public static final Item.ToolMaterial BRIGMANITE = createToolMaterial("brigmanite", 14, 1200, 22500.0F, 14.5F, 22, 3);
    public static final Item.ToolMaterial MAJORITE = createToolMaterial("majorite", 15, 1200, 33750.0F, 15.0F, 22, 3.5F);
    public static final Item.ToolMaterial AMAZONITE = createToolMaterial("amazonite", 100, 1200, 50000.0F, 17.5F, 22, 4);
    public static final Item.ToolMaterial ONYX = createToolMaterial("onyx", 1000, 2500, 100000.0F, 20.0F, 22, 4.5F);
