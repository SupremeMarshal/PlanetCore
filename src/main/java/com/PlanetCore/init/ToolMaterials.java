...
public class ToolMaterials {
    ...
    public static final Item.ToolMaterial COPPER = createToolMaterial("copper", 2, 200, 5.0F, 2.4F, 10, 4);
    public static final Item.ToolMaterial COMPLETE_COPPER = createToolMaterial("complete_copper", 2, 400, 5.5F, 2.4F, 10, 4);
    public static final Item.ToolMaterial ZINC = createToolMaterial("zinc", 2, 250, 8.0F, 3.4F, 22, 3);
    public static final Item.ToolMaterial COMPLETE_ZINC = createToolMaterial("complete_zinc", 2, 500, 8.5F, 3.4F, 22, 3);
    ...
    public static final Item.ToolMaterial BRONZE = createToolMaterial("bronze", 2, 300, 12.0F, 4.0F, 22, 5);
    public static final Item.ToolMaterial COMPLETE_BRONZE = createToolMaterial("complete_bronze", 2, 600, 14.0F, 4.0F, 22, 5);
    public static final Item.ToolMaterial IRON = createToolMaterial("iron", 2, 400, 7.0F, 4.6F, 22, 5);
    public static final Item.ToolMaterial COMPLETE_IRON = createToolMaterial("complete_iron", 2, 800, 8.0F, 4.6F, 22, 5);
    public static final Item.ToolMaterial STEEL = createToolMaterial("stone", 2, 800, 9.0F, 5.2F, 22, 5);
    public static final Item.ToolMaterial COMPLETE_STEEL = createToolMaterial("complete_steel", 2, 1600, 10.0F, 5.2F, 22, 5);
    ...
    public static final Item.ToolMaterial TITANIUM_URANIUM = createToolMaterial("titanium_uranium", 4, 1030, 46.0F, 12.0F, 22, 7);
    public static final Item.ToolMaterial COMPLETE_TITANIUM_URANIUM = createToolMaterial("complete_titanium_uranium", 4, 2060, 50.0F, 12.0F, 22, 7);
    public static final Item.ToolMaterial TUNGSTEN_URANIUM = createToolMaterial("tungsten_uranium", 4, 6030, 46.0F, 12.0F, 22, 7);
