...
public class ToolMaterials {
    ...
    public static final Item.ToolMaterial ALUMINUM = createToolMaterial("aluminum", 2, 50, 2.0F, 1.0F, 15, 3);
    public static final Item.ToolMaterial COMPLETE_ALUMINUM = createToolMaterial("complete_aluminum", 2, 100, 2.0F, 1.0F, 15, 3);
    ...
    public static final Item.ToolMaterial TITANUM = createToolMaterial("titanum", 3, 1000, 30.0F, 7.6F, 22, 4);
    public static final Item.ToolMaterial COMPLETE_TITANUM = createToolMaterial("complete_titanum", 3, 2000, 30.0F, 7.6F, 22, 4);
    public static final Item.ToolMaterial URANUM = createToolMaterial("uranum", 4, 30, 100.0F, 9.4F, 22, 3);
    public static final Item.ToolMaterial COMPLETE_URANUM = createToolMaterial("complete_uranum", 4, 60, 100.0F, 9.4F, 22, 3);
    ...
    public static final Item.ToolMaterial TITANUM_URANUM = createToolMaterial("titanum_uranum", 4, 1030, 130.0F, 12.0F, 22, 3);
    public static final Item.ToolMaterial COMPLETE_TITANUM_URANUM = createToolMaterial("complete_titanum_uranum", 4, 2060, 130.0F, 12.0F, 22, 3);
    public static final Item.ToolMaterial TUNGSTEN_URANUM = createToolMaterial("tungsten_uranum", 4, 2030, 142.0F, 12.0F, 22, 3);
    public static final Item.ToolMaterial COMPLETE_TUNGSTEN_URANUM = createToolMaterial("complete_tungsten_uranum", 4, 4060, 142.0F, 12.0F, 22, 3);
    public static final Item.ToolMaterial TUNGSTEN_TITANUM = createToolMaterial("tungsten_titanum", 4, 3000, 72.0F, 9.0F, 22, 4);
    public static final Item.ToolMaterial COMPLETE_TUNGSTEN_TITANUM = createToolMaterial("complete_tungsten_titanum", 4, 6000, 72.0F, 9.0F, 22, 4);
    ...
    public static final Item.ToolMaterial MAJORITE = createToolMaterial("majorite", 15, 3000, 5000.0F, 15.0F, 22, 5);
    public static final Item.ToolMaterial AMAZONITE = createToolMaterial("amazonite", 100, 5000, 10000.0F, 17.5F, 22, 6);
    public static final Item.ToolMaterial ONYX = createToolMaterial("onyx", 1000, 10000, 20000.0F, 20.0F, 22, 7);
