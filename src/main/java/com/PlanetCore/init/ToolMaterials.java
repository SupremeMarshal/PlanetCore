...
public class ToolMaterials {
    ...
    public static final Item.ToolMaterial SILVER = createToolMaterial("silver", 3, 200, 16.0F, 5.8F, 22, 5);
    public static final Item.ToolMaterial COMPLETE_SILVER = createToolMaterial("complete_silver", 3, 400, 18.0F, 5.8F, 22, 5);
    public static final Item.ToolMaterial GOLD = createToolMaterial("gold", 3, 300, 20.0F, 6.4F, 22, 5);
    public static final Item.ToolMaterial COMPLETE_GOLD = createToolMaterial("complete_gold", 3, 600, 22.0F, 6.4F, 22, 5);
    public static final Item.ToolMaterial PLATINUM = createToolMaterial("platinum", 3, 400, 24.0F, 7.0F, 22, 5);
    public static final Item.ToolMaterial COMPLETE_PLATINUM = createToolMaterial("complete_platinum", 3, 800, 26.0F, 7.0F, 22, 5);
    ...
    public static final Item.ToolMaterial TOPAZ = createToolMaterial("topaz", 4, 200, 45.0F, 8.2F, 22, 4);
    public static final Item.ToolMaterial JADE = createToolMaterial("jade", 4, 400, 60.0F, 8.8F, 22, 4);
    ...
    public static final Item.ToolMaterial EMERALD = createToolMaterial("emerald", 5, 600, 75.0F, 9.5F, 22, 3);
    public static final Item.ToolMaterial RUBY = createToolMaterial("ruby", 6, 900, 100.0F, 10.0F, 22, 4);
    public static final Item.ToolMaterial SAPPHIRE = createToolMaterial("sapphire", 6, 1200, 125.0F, 11.0F, 22, 4);
    public static final Item.ToolMaterial DIAMOND = createToolMaterial("diamond", 10, 1500, 150.0F, 12.5F, 22, 4);
    public static final Item.ToolMaterial OLIVINE = createToolMaterial("olivine", 11, 1600, 175.0F, 13.0F, 22, 4);
    public static final Item.ToolMaterial WADSLEYITE = createToolMaterial("wadsleyite", 12, 1800, 200.0F, 13.5F, 22, 5);
    public static final Item.ToolMaterial RINGWOODITE = createToolMaterial("ringwoodite", 13, 2000, 250.0F, 14.0F, 22, 5);
    public static final Item.ToolMaterial BRIGMANITE = createToolMaterial("brigmanite", 14, 2500, 300.0F, 14.5F, 22, 5);
    public static final Item.ToolMaterial MAJORITE = createToolMaterial("majorite", 15, 5000, 400.0F, 15.0F, 22, 6);
    public static final Item.ToolMaterial AMAZONITE = createToolMaterial("amazonite", 100, 10000, 500.0F, 17.5F, 22, 6);
    public static final Item.ToolMaterial ONYX = createToolMaterial("onyx", 1000, 20000, 1000.0F, 20.0F, 22, 6);
