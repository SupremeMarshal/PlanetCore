...
public class ToolMaterials {
    ...
    public static final Item.ToolMaterial STEEL = createToolMaterial("steel", 2, 500, 6.0F, 2, 22, 1.5F);
    public static final Item.ToolMaterial COMPLETE_STEEL = createToolMaterial("complete_steel", 2, 1000, 6.0F, 2, 22, 1.5F);
    ...
    public static final Item.ToolMaterial BRONZE = createToolMaterial("bronze", 2, 400, 7.0F, 2.5F, 22, 1.5F);
    public static final Item.ToolMaterial COMPLETE_BRONZE = createToolMaterial("complete_bronze", 2, 800, 7.0F, 2.5F, 22, 1.5F);
    public static final Item.ToolMaterial SILVER = createToolMaterial("silver", 3, 33, 10.0F, 0.0F, 22, 1.2F);
    public static final Item.ToolMaterial COMPLETE_SILVER = createToolMaterial("complete_silver", 3, 75, 10.0F, 0.0F, 22, 1.2F);
    public static final Item.ToolMaterial COMPLETE_GOLD = createToolMaterial("complete_gold", 3, 75, 12.0F, 0.0F, 22, 1.1F);
    public static final Item.ToolMaterial COMPLETE_DIAMOND = createToolMaterial("complete_diamond", 3, 3122, 8.0F, 3.0F, 22, 2.5F);
    public static final Item.ToolMaterial TITANIUM = createToolMaterial("titanium", 3, 500, 12.0F, 3.5F, 22, 1.7F);
    public static final Item.ToolMaterial COMPLETE_TITANIUM = createToolMaterial("complete_titanium", 3, 1000, 12.0F, 3.5F, 22, 1.7F);
    public static final Item.ToolMaterial URANIUM = createToolMaterial("uranium", 4, 120, 12.0F, 3.5F, 22, 1.7F);
    public static final Item.ToolMaterial COMPLETE_URANIUM = createToolMaterial("complete_uranium", 4, 240, 12.0F, 3.5F, 22, 1.7F);
    public static final Item.ToolMaterial TUNGSTEN = createToolMaterial("tungsten", 4, 2000, 16.0F, 4.0F, 22, 2F);
    public static final Item.ToolMaterial COMPLETE_TUNGSTEN = createToolMaterial("complete_tungsten", 4, 4000, 16.0F, 4.0F, 22, 2F);
    ...
    public static final Item.ToolMaterial RUBY = createToolMaterial("ruby", 6, 3122, 45.0F, 5.0F, 22, 2F);
    public static final Item.ToolMaterial SAPPHIRE = createToolMaterial("sapphire", 6, 3122, 60.0F, 5.5F, 22, 2F);
    ...
    public static final Item.ToolMaterial ONYX_III = createToolMaterial("onyx_III", 1000, 3122, 600.0F, 11.0F, 22, 2);
    public static final Item.ToolMaterial ONYX_IV = createToolMaterial("onyx_IV", 1000, 3122, 700.0F, 12.0F, 22, 2);
    public static final Item.ToolMaterial ONYX_V = createToolMaterial("onyx_V", 1000, 3122, 1000.0F, 13.0F, 22, 2);
