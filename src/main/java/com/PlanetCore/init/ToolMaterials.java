...
public class ToolMaterials {
    ...
    public static final Item.ToolMaterial STEEL = createToolMaterial("steel", 2, 500, 6.0F, 2.5F, 22, 2.0F);
    public static final Item.ToolMaterial COMPLETE_STEEL = createToolMaterial("complete_steel", 2, 1000, 6.0F, 2.5F, 22, 2.0F);
    public static final Item.ToolMaterial COPPER = createToolMaterial("copper", 2, 200, 4.0F, 2.8F, 10, 2.5F);
    public static final Item.ToolMaterial COMPLETE_COPPER = createToolMaterial("complete_copper", 2, 400, 4.0F, 2.8F, 10, 2.5F);
    ...
    public static final Item.ToolMaterial BRONZE = createToolMaterial("bronze", 2, 400, 10.0F, 4.0F, 22, 2.5F);
    public static final Item.ToolMaterial COMPLETE_BRONZE = createToolMaterial("complete_bronze", 2, 800, 10.0F, 4.0F, 22, 2.5F);
