...
public class ModBlocks {
    ...
    public static void register(IForgeRegistry<Block> registry) {
        ...
        registry.registerAll(
                ...
                new BlocksBase("aluminium_block", Material.ROCK).setResistance(1).setHardness(20F),
                new BlocksBase("zinc_block", Material.ROCK).setResistance(1).setHardness(25.0F),
                new BlocksBase("lead_block", Material.ROCK).setResistance(1).setHardness(25.0F),
                new BlocksBase("tin_block", Material.ROCK).setResistance(2).setHardness(25.0F),
                new BlocksBase("copper_block", Material.ROCK).setResistance(2).setHardness(25.0F),
                new BlocksBase("silicon_block", Material.ROCK).setResistance(1).setHardness(25.0F),
                new BlocksBase("iron_block", Material.ROCK).setResistance(3).setHardness(25.0F),
                new BlocksBase("steel_block", Material.ROCK).setResistance(4).setHardness(25.0F),
                new BlocksBase("bronze_block", Material.ROCK).setResistance(4).setHardness(25.0F),
                new BlocksBase("silver_block", Material.ROCK).setResistance(5).setHardness(30.0F),
                new BlocksBase("gold_block", Material.ROCK).setResistance(6).setHardness(35F),
                new BlocksBase("platinum_block", Material.ROCK).setResistance(7).setHardness(40F),
                new BlocksBase("titanium_block", Material.ROCK).setResistance(8).setHardness(45F),
                new BlocksBase("titanium_uranium_block", Material.ROCK).setResistance(8).setHardness(45F),
                new BlocksBase("uranium_block", Material.ROCK).setResistance(2).setHardness(45F),
                new BlocksBase("tungsten_block", Material.ROCK).setResistance(9).setHardness(50F),
                new BlocksBase("tungsten_uranium_block", Material.ROCK).setResistance(9).setHardness(55F),
                new BlocksBase("tungsten_titanium_block", Material.ROCK).setResistance(10).setHardness(60F),
                new BlocksBase("topaz_block", Material.ROCK).setResistance(6).setHardness(25F),
                new BlocksBase("jade_block", Material.ROCK).setResistance(6).setHardness(25F),
                new BlocksBase("sapphire_block", Material.ROCK).setResistance(11),
                new BlocksBase("ruby_block", Material.ROCK).setResistance(11),
                new BlocksBase("diamond_block", Material.ROCK).setResistance(12),
                new BlocksBase("olivine_block", Material.ROCK).setResistance(13),
                new BlocksBase("wadsleyite_block", Material.ROCK).setResistance(14),
                new BlocksBase("ringwoodite_block", Material.ROCK).setResistance(15),
                new BlocksBase("brigmanite_block", Material.ROCK).setResistance(16),
                new BlocksBase("majorite_block", Material.ROCK).setResistance(17),
                new BlocksBase("amazonite_block", Material.ROCK).setResistance(18),
                new BlocksBase("onyx_block", Material.ROCK).setResistance(19),
