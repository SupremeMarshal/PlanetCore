...
public class ModBlocks {
	...
	public static final Block ONYX_BLOCK = new RockBase("onyx_block", Material.ROCK).setResistance(1000000);
	public static final Block AMETHYST_BLOCK = new RockBase("amethyst_block", Material.ROCK);
	public static final Block AMAZONITE_BLOCK = new RockBase("amazonite_block", Material.ROCK).setResistance(500000);
	public static final Block JADE_BLOCK = new RockBase("jade_block", Material.ROCK);
	public static final Block DIAMOND_BLOCK = new RockBase("diamond_block", Material.ROCK).setResistance(200000);
	public static final Block TOPAZ_BLOCK = new RockBase("topaz_block", Material.ROCK);
	public static final Block RUBY_BLOCK = new RockBase("ruby_block", Material.ROCK).setResistance(100000);
	public static final Block FLAMING_TOPAZ_BLOCK = new RockBase("flaming_topaz_block", Material.ROCK);
	public static final Block SAPPHIRE_BLOCK = new RockBase("sapphire_block", Material.ROCK).setResistance(50000);
	public static final Block PLATINUM_BLOCK = new RockBase("platinum_block", Material.ROCK).setResistance(3000);
	public static final Block GOLD_BLOCK = new RockBase("gold_block", Material.ROCK).setResistance(2000);
	public static final Block SILVER_BLOCK = new RockBase("silver_block", Material.ROCK).setResistance(1000);
	public static final Block STEEL_BLOCK = new RockBase("steel_block", Material.ROCK).setResistance(500);
	public static final Block IRON_BLOCK = new RockBase("iron_block", Material.ROCK).setResistance(100);
