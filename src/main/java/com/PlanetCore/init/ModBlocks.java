...
public class ModBlocks {
    ...
    public static void register(IForgeRegistry<Block> registry) {
        ...
        registry.registerAll(
                ...
                new BlocksBase("tin_supercompact", Material.ROCK, PlanetMaterial.TIN, PlanetHardness.TIN_SUPERCOMPACT).setResistance(1),
                new BlocksBase("copper_supercompact", Material.ROCK, PlanetMaterial.COPPER, PlanetHardness.COPPER_SUPERCOMPACT).setResistance(1),
                new BlocksBase("iron_supercompact", Material.ROCK, PlanetMaterial.IRON, PlanetHardness.IRON_SUPERCOMPACT).setResistance(1),
                new BlocksBase("silver_supercompact", Material.ROCK, PlanetMaterial.SILVER, PlanetHardness.SILVER_SUPERCOMPACT).setResistance(1),
                new BlocksBase("gold_supercompact", Material.ROCK, PlanetMaterial.GOLD, PlanetHardness.GOLD_SUPERCOMPACT).setResistance(1),
                new BlocksBase("diamond_supercompact", Material.ROCK, PlanetMaterial.DIAMOND, PlanetHardness.DIAMOND_SUPERCOMPACT).setResistance(1),
                new BlocksBase("titanium_supercompact", Material.ROCK, PlanetMaterial.TITANIUM, PlanetHardness.TITANIUM_SUPERCOMPACT).setResistance(3),
                new BlocksBase("uranium_supercompact", Material.ROCK, PlanetMaterial.URANIUM, PlanetHardness.URANIUM_SUPERCOMPACT).setResistance(4),
                new BlocksBase("tungsten_supercompact", Material.ROCK, PlanetMaterial.TUNGSTEN, PlanetHardness.TUNGSTEN_SUPERCOMPACT).setResistance(5),
                new BlocksBase("topaz_supercompact", Material.ROCK, PlanetMaterial.TOPAZ, PlanetHardness.TOPAZ_SUPERCOMPACT).setResistance(6),
                new BlocksBase("jade_supercompact", Material.ROCK, PlanetMaterial.JADE, PlanetHardness.JADE_SUPERCOMPACT).setResistance(7),
                new BlocksBase("ruby_supercompact", Material.ROCK, PlanetMaterial.RUBY, PlanetHardness.RUBY_SUPERCOMPACT).setResistance(8),
                new BlocksBase("sapphire_supercompact", Material.ROCK, PlanetMaterial.SAPPHIRE, PlanetHardness.SAPPHIRE_SUPERCOMPACT).setResistance(9),
                ...
                new OreCompactBase("ore_compact_diamond", Material.ROCK, PlanetMaterial.DIAMOND, PlanetHardness.DIAMOND_COMPACT).setResistance(1),
                ...
                new OreCompactBase("ore_compact_emerald", Material.ROCK, PlanetMaterial.EMERALD, PlanetHardness.EMERALD_COMPACT).setResistance(1),
                ...
                new CrustrockOreCompact("crustrock_compact_diamond", Material.ROCK, PlanetMaterial.DIAMOND, PlanetHardness.DIAMOND_COMPACT).setResistance(1),
                new CrustrockOreCompact("crustrock_compact_emerald", Material.ROCK, PlanetMaterial.EMERALD, PlanetHardness.EMERALD_COMPACT).setResistance(1),
                new CrustrockOreCompact("crustrock_compact_sulfur", Material.ROCK, PlanetMaterial.SULFUR, PlanetHardness.SULFUR_COMPACT).setResistance(1),
                new CrustrockOreCompact("crustrock_compact_redstone", Material.ROCK, PlanetMaterial.REDSTONE, PlanetHardness.REDSTONE_COMPACT).setResistance(1),
                new CrustrockOreCompact("crustrock_compact_lapis", Material.ROCK, PlanetMaterial.LAPIS, PlanetHardness.LAPIS_COMPACT).setResistance(1),
                new CrustrockOreCompact("crustrock_compact_titanium", Material.ROCK, PlanetMaterial.TITANIUM, PlanetHardness.TITANIUM_COMPACT).setResistance(1),
                ...
                new MantlerockOreCompact("mantlerock_compact_titanium", Material.ROCK, PlanetMaterial.TITANIUM, PlanetHardness.TITANIUM_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_uranium", Material.ROCK, PlanetMaterial.URANIUM, PlanetHardness.URANIUM_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_tungsten", Material.ROCK, PlanetMaterial.TUNGSTEN, PlanetHardness.TUNGSTEN_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_topaz", Material.ROCK, PlanetMaterial.TOPAZ, PlanetHardness.TOPAZ_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_jade", Material.ROCK, PlanetMaterial.JADE, PlanetHardness.JADE_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_ruby", Material.ROCK, PlanetMaterial.RUBY, PlanetHardness.RUBY_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_sapphire", Material.ROCK, PlanetMaterial.SAPPHIRE, PlanetHardness.SAPPHIRE_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_diamond", Material.ROCK, PlanetMaterial.DIAMOND, PlanetHardness.DIAMOND_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_emerald", Material.ROCK, PlanetMaterial.EMERALD, PlanetHardness.EMERALD_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_olivine", Material.ROCK, PlanetMaterial.OLIVINE, PlanetHardness.OLIVINE_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_wadsleyite", Material.ROCK, PlanetMaterial.WADSLEYITE, PlanetHardness.WADSLEYITE_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_ringwoodite", Material.ROCK, PlanetMaterial.RINGWOODITE, PlanetHardness.RINGWOODITE_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_brigmanite", Material.ROCK, PlanetMaterial.BRIGMANITE, PlanetHardness.BRIGMANITE_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_majorite", Material.ROCK, PlanetMaterial.MAJORITE, PlanetHardness.MAJORITE_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_amazonite", Material.ROCK, PlanetMaterial.AMAZONITE, PlanetHardness.AMAZONITE_COMPACT).setResistance(1),
