...
public class ModBlocks {
	...
	public static final Block MANTLEROCK = new Mantlerock("mantlerock", Material.ROCK);
	public static final Block MANTLEROCK1 = new Mantlerock("mantlerock1", Material.ROCK);
	public static final Block MANTLEROCK2 = new Mantlerock("mantlerock2", Material.ROCK);
	public static final Block MANTLEROCK3 = new Mantlerock("mantlerock3", Material.ROCK);
	public static final Block MANTLEROCK4 = new Mantlerock("mantlerock4", Material.ROCK);
	public static final Block MANTLEROCK5 = new Mantlerock("mantlerock5", Material.ROCK);
	public static final Block MANTLEROCK6 = new Mantlerock("mantlerock6", Material.ROCK);
	public static final Block MANTLEROCK7 = new Mantlerock("mantlerock7", Material.ROCK);
	public static final Block MANTLEROCK8 = new Mantlerock("mantlerock8", Material.ROCK);
	public static final Block MANTLEROCK9 = new Mantlerock("mantlerock9", Material.ROCK);
	public static final Block MANTLEROCK10 = new Mantlerock("mantlerock10", Material.ROCK);
	public static final Block LOWER_MANTLEROCK1 = new Mantlerock("lower_mantlerock1", Material.ROCK);
	public static final Block LOWER_MANTLEROCK2 = new Mantlerock("lower_mantlerock2", Material.ROCK);
	public static final Block LOWER_MANTLEROCK3 = new Mantlerock("lower_mantlerock3", Material.ROCK);
	public static final Block LOWER_MANTLEROCK4 = new Mantlerock("lower_mantlerock4", Material.ROCK);
	public static final Block LOWER_MANTLEROCK5 = new Mantlerock("lower_mantlerock5", Material.ROCK);
	public static final Block LOWER_MANTLEROCK6 = new Mantlerock("lower_mantlerock6", Material.ROCK);
	public static final Block LOWER_MANTLEROCK7 = new Mantlerock("lower_mantlerock7", Material.ROCK);
	public static final Block LOWER_MANTLEROCK8 = new Mantlerock("lower_mantlerock8", Material.ROCK);
	public static final Block LOWER_MANTLEROCK9 = new Mantlerock("lower_mantlerock9", Material.ROCK);
	public static final Block LOWER_MANTLEROCK10 = new Mantlerock("lower_mantlerock10", Material.ROCK);
