...
public class ModBlocks {
    ...
    public enum Ore {
        ...
        EMERALD(OreType.GEM, 120.0F, 3.5F),
        TUNGSTEN(METAL, 100.0F, 3.0F),
        JADE(OreType.GEM, 40.0F, 2.5F),
        TOPAZ(OreType.GEM, 30.0F, 2.0F),
        TITANIUM(METAL, 25.0F, 1.5F),
        URANIUM(METAL, 8.0F, 1.0F),
        PLATINUM(METAL, 16.0F, 1.3F),
        GOLD(METAL, 12.0F, 1.2F),
        SILVER(METAL, 8.0F, 1.1F),
        IRON(METAL, 6.0F, 1.0F),
