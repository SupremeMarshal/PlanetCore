...
public class ModBlocks {
    ...
    public static void register(IForgeRegistry<Block> registry) {
        ...
        registry.registerAll(
                ...
                new BlocksBase("jade_supercompact", Material.ROCK, PlanetMaterial.JADE, PlanetHardness.JADE_SUPERCOMPACT, PlanetExp.JADE_SUPERCOMPACT).setResistance(50),
                ...
                new BlocksBase("olivine_supercompact", Material.ROCK, PlanetMaterial.OLIVINE, PlanetHardness.OLIVINE_SUPERCOMPACT, PlanetExp.OLIVINE_SUPERCOMPACT).setResistance(120),
                new BlocksBase("wadsleyite_supercompact", Material.ROCK, PlanetMaterial.WADSLEYITE, PlanetHardness.WADSLEYITE_SUPERCOMPACT, PlanetExp.WADSLEYITE_SUPERCOMPACT).setResistance(140),
                new BlocksBase("ringwoodite_supercompact", Material.ROCK, PlanetMaterial.RINGWOODITE, PlanetHardness.RINGWOODITE_SUPERCOMPACT, PlanetExp.RINGWOODITE_SUPERCOMPACT).setResistance(160),
                new BlocksBase("brigmanite_supercompact", Material.ROCK, PlanetMaterial.BRIGMANITE, PlanetHardness.BRIGMANITE_SUPERCOMPACT, PlanetExp.BRIGMANITE_SUPERCOMPACT).setResistance(180),
                ...
                new OreBase("ore_aluminium", Material.ROCK, PlanetMaterial.ALUMINIUM, PlanetHardness.ALUMINIUM,PlanetExp.ALUMINIUM).setResistance(1),
                new OreBase("ore_iron", Material.ROCK, PlanetMaterial.IRON, PlanetHardness.IRON,PlanetExp.IRON).setResistance(1),
                new OreBase("ore_copper", Material.ROCK, PlanetMaterial.COPPER, PlanetHardness.COPPER,PlanetExp.COPPER).setResistance(1),
                new OreBase("ore_tin", Material.ROCK, PlanetMaterial.TIN, PlanetHardness.TIN,PlanetExp.TIN).setResistance(1),
                ...
                new OreCompactBase("ore_compact_aluminium", Material.ROCK, PlanetMaterial.ALUMINIUM, PlanetHardness.ALUMINIUM_COMPACT,PlanetExp.ALUMINIUM_COMPACT).setResistance(1),
                ...
                new OreCompactBase("ore_compact_copper", Material.ROCK, PlanetMaterial.COPPER, PlanetHardness.COPPER_COMPACT,PlanetExp.COPPER_COMPACT).setResistance(1),
                new OreCompactBase("ore_compact_tin", Material.ROCK, PlanetMaterial.TIN, PlanetHardness.TIN_COMPACT,PlanetExp.TIN_COMPACT).setResistance(1),
                ...
                new CrustrockOre("crustrock_aluminium", Material.ROCK, PlanetMaterial.ALUMINIUM, PlanetHardness.ALUMINIUM,PlanetExp.ALUMINIUM).setResistance(1),
                new CrustrockOre("crustrock_iron", Material.ROCK, PlanetMaterial.IRON, PlanetHardness.IRON,PlanetExp.IRON).setResistance(1),
                new CrustrockOre("crustrock_copper", Material.ROCK, PlanetMaterial.COPPER, PlanetHardness.COPPER,PlanetExp.COPPER).setResistance(1),
                new CrustrockOre("crustrock_tin", Material.ROCK, PlanetMaterial.TIN, PlanetHardness.TIN,PlanetExp.TIN).setResistance(1),
                ...
                new CrustrockOre("crustrock_topaz", Material.ROCK, PlanetMaterial.TOPAZ, PlanetHardness.TOPAZ,PlanetExp.TOPAZ).setResistance(1),
                ...
                new CrustrockOre("crustrock_jade", Material.ROCK, PlanetMaterial.JADE, PlanetHardness.JADE,PlanetExp.JADE).setResistance(1),
                ...
                new CrustrockOreCompact("crustrock_compact_aluminium", Material.ROCK, PlanetMaterial.ALUMINIUM, PlanetHardness.ALUMINIUM_COMPACT,PlanetExp.ALUMINIUM_COMPACT).setResistance(1),
                ...
                new CrustrockOreCompact("crustrock_compact_copper", Material.ROCK, PlanetMaterial.COPPER, PlanetHardness.COPPER_COMPACT,PlanetExp.COPPER_COMPACT).setResistance(1),
                new CrustrockOreCompact("crustrock_compact_tin", Material.ROCK, PlanetMaterial.TIN, PlanetHardness.TIN_COMPACT,PlanetExp.TIN_COMPACT).setResistance(1),
                ...
                new CrustrockOreCompact("crustrock_compact_topaz", Material.ROCK, PlanetMaterial.TOPAZ, PlanetHardness.TOPAZ_COMPACT,PlanetExp.TOPAZ_COMPACT).setResistance(10),
                ...
                new CrustrockOreCompact("crustrock_compact_jade", Material.ROCK, PlanetMaterial.TUNGSTEN, PlanetHardness.TUNGSTEN_COMPACT,PlanetExp.TUNGSTEN_COMPACT).setResistance(10),

                new MantlerockOre("mantlerock_coal", Material.ROCK, PlanetMaterial.COAL, PlanetHardness.COAL,PlanetExp.COAL).setResistance(1),
                new MantlerockOre("mantlerock_aluminium", Material.ROCK, PlanetMaterial.ALUMINIUM, PlanetHardness.ALUMINIUM,PlanetExp.ALUMINIUM).setResistance(1),
                new MantlerockOre("mantlerock_iron", Material.ROCK, PlanetMaterial.IRON, PlanetHardness.IRON,PlanetExp.IRON).setResistance(1),
                new MantlerockOre("mantlerock_copper", Material.ROCK, PlanetMaterial.COPPER, PlanetHardness.COPPER,PlanetExp.COPPER).setResistance(1),
                new MantlerockOre("mantlerock_tin", Material.ROCK, PlanetMaterial.TIN, PlanetHardness.TIN,PlanetExp.TIN).setResistance(1),
                ...
                new MantlerockOre("mantlerock_jade", Material.ROCK, PlanetMaterial.JADE, PlanetHardness.JADE,PlanetExp.JADE).setResistance(1),
                ...
                new MantlerockOre("mantlerock_olivine", Material.ROCK, PlanetMaterial.OLIVINE, PlanetHardness.OLIVINE,PlanetExp.OLIVINE).setResistance(10),
                new MantlerockOre("mantlerock_wadsleyite", Material.ROCK, PlanetMaterial.WADSLEYITE, PlanetHardness.WADSLEYITE,PlanetExp.WADSLEYITE).setResistance(10),
                new MantlerockOre("mantlerock_ringwoodite", Material.ROCK, PlanetMaterial.RINGWOODITE, PlanetHardness.RINGWOODITE,PlanetExp.RINGWOODITE).setResistance(10),
                new MantlerockOre("mantlerock_brigmanite", Material.ROCK, PlanetMaterial.BRIGMANITE, PlanetHardness.BRIGMANITE,PlanetExp.BRIGMANITE).setResistance(10),
                ...
                new MantlerockOreCompact("mantlerock_compact_aluminium", Material.ROCK, PlanetMaterial.ALUMINIUM, PlanetHardness.ALUMINIUM_COMPACT,PlanetExp.ALUMINIUM_COMPACT).setResistance(1),
                ...
                new MantlerockOreCompact("mantlerock_compact_copper", Material.ROCK, PlanetMaterial.COPPER, PlanetHardness.COPPER_COMPACT,PlanetExp.COPPER_COMPACT).setResistance(1),
                new MantlerockOreCompact("mantlerock_compact_tin", Material.ROCK, PlanetMaterial.TIN, PlanetHardness.TIN_COMPACT,PlanetExp.TIN_COMPACT).setResistance(1),
                ...
                new MantlerockOreCompact("mantlerock_compact_jade", Material.ROCK, PlanetMaterial.JADE, PlanetHardness.JADE_COMPACT,PlanetExp.JADE_COMPACT).setResistance(10),
                ...
                new MantlerockOreCompact("mantlerock_compact_olivine", Material.ROCK, PlanetMaterial.OLIVINE, PlanetHardness.OLIVINE_COMPACT,PlanetExp.OLIVINE_COMPACT).setResistance(100),
                new MantlerockOreCompact("mantlerock_compact_wadsleyite", Material.ROCK, PlanetMaterial.WADSLEYITE, PlanetHardness.WADSLEYITE_COMPACT,PlanetExp.WADSLEYITE_COMPACT).setResistance(100),
                new MantlerockOreCompact("mantlerock_compact_ringwoodite", Material.ROCK, PlanetMaterial.RINGWOODITE, PlanetHardness.RINGWOODITE_COMPACT,PlanetExp.RINGWOODITE_COMPACT).setResistance(100),
                new MantlerockOreCompact("mantlerock_compact_brigmanite", Material.ROCK, PlanetMaterial.BRIGMANITE, PlanetHardness.BRIGMANITE_COMPACT,PlanetExp.BRIGMANITE_COMPACT).setResistance(100),
                ...
                new MantlerockOreCompact("mantlerock_compact_amazonite", Material.ROCK, PlanetMaterial.AMAZONITE, PlanetHardness.AMAZONITE_COMPACT,PlanetExp.AMAZONITE_COMPACT).setResistance(100),
                ...
                new CorestoneOre("corestone_olivine", Material.ROCK, PlanetMaterial.OLIVINE, PlanetHardness.OLIVINE,PlanetExp.OLIVINE).setResistance(100),
                new CorestoneOre("corestone_wadsleyite", Material.ROCK, PlanetMaterial.WADSLEYITE, PlanetHardness.WADSLEYITE,PlanetExp.WADSLEYITE).setResistance(100),
                new CorestoneOre("corestone_ringwoodite", Material.ROCK, PlanetMaterial.RINGWOODITE, PlanetHardness.RINGWOODITE,PlanetExp.RINGWOODITE).setResistance(100),
                new CorestoneOre("corestone_brigmanite", Material.ROCK, PlanetMaterial.BRIGMANITE, PlanetHardness.BRIGMANITE,PlanetExp.BRIGMANITE).setResistance(100),
                ...
                new CorestoneOreCompact("corestone_compact_olivine", Material.ROCK, PlanetMaterial.OLIVINE, PlanetHardness.OLIVINE_COMPACT,PlanetExp.OLIVINE_COMPACT).setResistance(100),
                new CorestoneOreCompact("corestone_compact_wadsleyite", Material.ROCK, PlanetMaterial.WADSLEYITE, PlanetHardness.WADSLEYITE_COMPACT,PlanetExp.WADSLEYITE_COMPACT).setResistance(100),
                new CorestoneOreCompact("corestone_compact_ringwoodite", Material.ROCK, PlanetMaterial.RINGWOODITE, PlanetHardness.RINGWOODITE_COMPACT,PlanetExp.RINGWOODITE_COMPACT).setResistance(100),
                new CorestoneOreCompact("corestone_compact_brigmanite", Material.ROCK, PlanetMaterial.BRIGMANITE, PlanetHardness.BRIGMANITE_COMPACT,PlanetExp.BRIGMANITE_COMPACT).setResistance(100),
