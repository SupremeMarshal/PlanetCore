...
public class ModBlocks {
    ...
    public enum Ore {
        ...
        ONYX(OreType.GEM, 555.0F, 500000.0F),
        AMAZONITE( OreType.GEM, 444.2F, 300000.0F),
        MAJORITE( OreType.GEM, 355.4F, 200000.0F),
        BRIGMANITE( OreType.GEM, 284.3F, 100000.0F),
        RINGWOODITE( OreType.GEM, 227.4F, 80000.0F),
        WADSLEYITE( OreType.GEM, 181.9F, 70000.0F),
        OLIVINE( OreType.GEM, 145.5F, 60000.0F),
        DIAMOND( OreType.GEM, 116.4F, 50000.0F),
        SAPPHIRE( OreType.GEM, 74.5F, 10000.0F),
        RUBY( OreType.GEM, 74.5F, 10000.0F),
        EMERALD( OreType.GEM, 59.6F, 2500.0F),
        TUNGSTEN( METAL, 24.4F, 5000.0F),
        JADE( OreType.GEM, 47.7F, 1000.0F),
        TOPAZ(OreType.GEM, 38.1F, 500.0F),
        TITANIUM( METAL, 19.5F, 200.0F),
        URANIUM( METAL, 30.5F, 2.0F),
        PLATINUM( METAL, 15.6F, 5.0F),
        GOLD(METAL, 12.5F, 4.0F),
        SILVER(METAL, 10.0F, 3.0F),
