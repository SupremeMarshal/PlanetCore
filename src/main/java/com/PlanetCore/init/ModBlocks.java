...
public class ModBlocks {
    ...
    public static void register(IForgeRegistry<Block> registry) {
        ...
        registry.registerAll(
                ...
                new MantlerockOreCompact("mantlerock_compact_olivine", Material.ROCK, PlanetMaterial.OLIVINE, PlanetHardness.OLIVINE_COMPACT,PlanetExp.OLIVINE_COMPACT).setResistance(10),
                new MantlerockOreCompact("mantlerock_compact_wadsleyite", Material.ROCK, PlanetMaterial.WADSLEYITE, PlanetHardness.WADSLEYITE_COMPACT,PlanetExp.WADSLEYITE_COMPACT).setResistance(10),
                new MantlerockOreCompact("mantlerock_compact_ringwoodite", Material.ROCK, PlanetMaterial.RINGWOODITE, PlanetHardness.RINGWOODITE_COMPACT,PlanetExp.RINGWOODITE_COMPACT).setResistance(10),
                new MantlerockOreCompact("mantlerock_compact_brigmanite", Material.ROCK, PlanetMaterial.BRIGMANITE, PlanetHardness.BRIGMANITE_COMPACT,PlanetExp.BRIGMANITE_COMPACT).setResistance(10),
                new MantlerockOreCompact("mantlerock_compact_majorite", Material.ROCK, PlanetMaterial.MAJORITE, PlanetHardness.MAJORITE_COMPACT,PlanetExp.MAJORITE_COMPACT).setResistance(10),
                ...
                new CorestoneOre("corestone_olivine", Material.ROCK, PlanetMaterial.OLIVINE, PlanetHardness.OLIVINE,PlanetExp.OLIVINE).setResistance(10),
                new CorestoneOre("corestone_wadsleyite", Material.ROCK, PlanetMaterial.WADSLEYITE, PlanetHardness.WADSLEYITE,PlanetExp.WADSLEYITE).setResistance(10),
                new CorestoneOre("corestone_ringwoodite", Material.ROCK, PlanetMaterial.RINGWOODITE, PlanetHardness.RINGWOODITE,PlanetExp.RINGWOODITE).setResistance(10),
                new CorestoneOre("corestone_brigmanite", Material.ROCK, PlanetMaterial.BRIGMANITE, PlanetHardness.BRIGMANITE,PlanetExp.BRIGMANITE).setResistance(10),
                ...
                new CorestoneOreCompact("corestone_compact_olivine", Material.ROCK, PlanetMaterial.OLIVINE, PlanetHardness.OLIVINE_COMPACT,PlanetExp.OLIVINE_COMPACT).setResistance(10),
                new CorestoneOreCompact("corestone_compact_wadsleyite", Material.ROCK, PlanetMaterial.WADSLEYITE, PlanetHardness.WADSLEYITE_COMPACT,PlanetExp.WADSLEYITE_COMPACT).setResistance(10),
                new CorestoneOreCompact("corestone_compact_ringwoodite", Material.ROCK, PlanetMaterial.RINGWOODITE, PlanetHardness.RINGWOODITE_COMPACT,PlanetExp.RINGWOODITE_COMPACT).setResistance(10),
                new CorestoneOreCompact("corestone_compact_brigmanite", Material.ROCK, PlanetMaterial.BRIGMANITE, PlanetHardness.BRIGMANITE_COMPACT,PlanetExp.BRIGMANITE_COMPACT).setResistance(10),
                new CorestoneOreCompact("corestone_compact_majorite", Material.ROCK, PlanetMaterial.MAJORITE, PlanetHardness.MAJORITE_COMPACT,PlanetExp.MAJORITE_COMPACT).setResistance(10),
