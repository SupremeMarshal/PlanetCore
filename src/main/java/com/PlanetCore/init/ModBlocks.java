...
public class ModBlocks {
    ...
    public static void register(IForgeRegistry<Block> registry) {
        ...
        registry.registerAll(
                ...
                new BlocksBase("zinc_supercompact", Material.ROCK).setResistance(2).setHardness(108.0F),
                new BlocksBase("lead_supercompact", Material.ROCK).setResistance(2).setHardness(32.0F),
                new BlocksBase("tin_supercompact", Material.ROCK).setResistance(2).setHardness(72.0F),
                new BlocksBase("copper_supercompact", Material.ROCK).setResistance(2).setHardness(72.0F),
                new BlocksBase("silicon_supercompact", Material.ROCK).setResistance(2).setHardness(48.0F),
                new BlocksBase("iron_supercompact", Material.ROCK).setResistance(5).setHardness(162.0F),
                new BlocksBase("silver_supercompact", Material.ROCK).setResistance(5).setHardness(546),
                new BlocksBase("gold_supercompact", Material.ROCK).setResistance(6).setHardness(820),
                new BlocksBase("platinum_supercompact", Material.ROCK).setResistance(6).setHardness(1230),
                new BlocksBase("titanium_supercompact", Material.ROCK).setResistance(7).setHardness(1845),
                new BlocksBase("uranium_supercompact", Material.ROCK).setResistance(5).setHardness(4151),
                new BlocksBase("tungsten_supercompact", Material.ROCK).setResistance(8).setHardness(2767),
                new BlocksBase("topaz_supercompact", Material.ROCK).setResistance(7).setHardness(6227),
                new BlocksBase("jade_supercompact", Material.ROCK).setResistance(8).setHardness(9341),
                new BlocksBase("emerald_supercompact", Material.ROCK).setResistance(3).setHardness(14012),
                new BlocksBase("ruby_supercompact", Material.ROCK).setResistance(10).setHardness(21018),
                new BlocksBase("sapphire_supercompact", Material.ROCK).setResistance(9).setHardness(31528),
                new BlocksBase("diamond_supercompact", Material.ROCK).setResistance(11).setHardness(47292),
                new BlocksBase("olivine_supercompact", Material.ROCK).setResistance(12).setHardness(78938),
                new BlocksBase("wadsleyite_supercompact", Material.ROCK).setResistance(13).setHardness(106408),
                new BlocksBase("ringwoodite_supercompact", Material.ROCK).setResistance(14).setHardness(159612),
                new BlocksBase("brigmanite_supercompact", Material.ROCK).setResistance(15).setHardness(239418),
                new BlocksBase("majorite_supercompact", Material.ROCK).setResistance(16).setHardness(359127),
                new BlocksBase("amazonite_supercompact", Material.ROCK).setResistance(17).setHardness(538691),
                new BlocksBase("onyx_supercompact", Material.ROCK).setResistance(18).setHardness(808037),
