...
public class ModFluids
{
	...
	public static final Fluid PLATINUM_LAVA_FLUID = new FluidLiquid("platinum_lava", new ResourceLocation("planetcore:blocks/platinum_lava_still"), new ResourceLocation("planetcore:blocks/platinum_lava_flow"));
	...
	public static final Fluid EMERALD_LAVA_FLUID = new FluidLiquid("emerald_lava", new ResourceLocation("planetcore:blocks/emerald_lava_still"), new ResourceLocation("planetcore:blocks/emerald_lava_flow"));
	...
	public static final Fluid CENTERCORE_LAVA_FLUID = new FluidLiquid("centercore_lava", new ResourceLocation("planetcore:blocks/centercore_lava_still"), new ResourceLocation("planetcore:blocks/centercore_lava_flow"));
	...
	public static void registerFluids()
	{
		...
		registerFluid(CENTERCORE_LAVA_FLUID);
