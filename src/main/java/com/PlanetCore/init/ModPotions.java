...
public class ModPotions {
    ...
    public static void registerPotions(){
        ...
        PotionHelper.addMix(FIRE_RESISTANCE_II_POTION, ModItems.VERY_HOT_MAGMA_CREAM, FIRE_RESISTANCE_III_POTION);
        ...
        PotionHelper.addMix(VERY_LONG_FIRE_RESISTANCE_II_POTION, ModItems.VERY_HOT_MAGMA_CREAM, VERY_LONG_FIRE_RESISTANCE_III_POTION);
        ...
        PotionHelper.addMix(LONG_FIRE_RESISTANCE_II_POTION, ModItems.VERY_HOT_MAGMA_CREAM, LONG_FIRE_RESISTANCE_III_POTION);
