...
public class ModPotions {
    ...
    public static final PotionType LONG_FIRE_RESISTANCE_IV_POTION = new PotionType("long_fire_resistance_IV", new PotionEffect[] { new PotionEffect(MobEffects.FIRE_RESISTANCE, 20*60*8, 3)}).setRegistryName("long_fire_resistance_IV");
    public static final PotionType VERY_LONG_FIRE_RESISTANCE_IV_POTION = new PotionType("very_long_fire_resistance_IV", new PotionEffect[] { new PotionEffect(MobEffects.FIRE_RESISTANCE, 36000, 3)}).setRegistryName("very_long_fire_resistance_IV");
    ...
    public static final PotionType LONG_FIRE_RESISTANCE_V_POTION = new PotionType("long_fire_resistance_V", new PotionEffect[] { new PotionEffect(MobEffects.FIRE_RESISTANCE, 20*60*8, 4)}).setRegistryName("long_fire_resistance_V");
    public static final PotionType VERY_LONG_FIRE_RESISTANCE_V_POTION = new PotionType("very_long_fire_resistance_V", new PotionEffect[] { new PotionEffect(MobEffects.FIRE_RESISTANCE, 36000, 4)}).setRegistryName("very_long_fire_resistance_V");
    ...
    public static void registerPotions(){
        ...
        PotionHelper.addMix(PotionTypes.LONG_FIRE_RESISTANCE, Item.getItemFromBlock(Blocks.REDSTONE_BLOCK), VERY_LONG_FIRE_RESISTANCE_POTION);
        // short n -> short n+1
        ...
        PotionHelper.addMix(LONG_FIRE_RESISTANCE_II_POTION, Item.getItemFromBlock(Blocks.REDSTONE_BLOCK), VERY_LONG_FIRE_RESISTANCE_II_POTION);
        PotionHelper.addMix(LONG_FIRE_RESISTANCE_III_POTION, Item.getItemFromBlock(Blocks.REDSTONE_BLOCK), VERY_LONG_FIRE_RESISTANCE_III_POTION);
        PotionHelper.addMix(LONG_FIRE_RESISTANCE_IV_POTION, Item.getItemFromBlock(Blocks.REDSTONE_BLOCK), VERY_LONG_FIRE_RESISTANCE_IV_POTION);
        PotionHelper.addMix(LONG_FIRE_RESISTANCE_V_POTION, Item.getItemFromBlock(Blocks.REDSTONE_BLOCK), VERY_LONG_FIRE_RESISTANCE_V_POTION);

        PotionHelper.addMix(VERY_LONG_FIRE_RESISTANCE_POTION, ModItems.HOT_MAGMA_CREAM, VERY_LONG_FIRE_RESISTANCE_II_POTION);
        PotionHelper.addMix(VERY_LONG_FIRE_RESISTANCE_II_POTION, ModItems.DEMON_STAR, VERY_LONG_FIRE_RESISTANCE_III_POTION);
