...
public class ModToolMaterials {
    ...
    public static final Item.ToolMaterial COMPLETE_GOLD = createToolMaterial("complete_gold", 2, 75, 13.0F, 0.5F, 22, 1.5F);
    public static final Item.ToolMaterial COMPLETE_DIAMOND = createToolMaterial("complete_diamond", 3, 3122, 9.0F, 3.5F, 22, 2.5F);
    public static final Item.ToolMaterial TITANIUM = createToolMaterial("titanium", 4, 500, 12.0F, 4.5F, 22, 2.5F);
    public static final Item.ToolMaterial COMPLETE_TITANIUM = createToolMaterial("complete_titanium", 4, 1000, 13.0F, 4.5F, 22, 2.5F);
    public static final Item.ToolMaterial URANIUM = createToolMaterial("uranium", 4, 120, 15.0F, 5.0F, 22, 3.0F);
    public static final Item.ToolMaterial COMPLETE_URANIUM = createToolMaterial("complete_uranium", 4, 240, 16.0F, 5.5F, 22, 3.0F);
    public static final Item.ToolMaterial TUNGSTEN = createToolMaterial("tungsten", 5, 2000, 20.0F, 6.0F, 22, 3.5F);
    public static final Item.ToolMaterial COMPLETE_TUNGSTEN = createToolMaterial("complete_tungsten", 5, 4000, 21.0F, 6.5F, 22, 3.5F);
