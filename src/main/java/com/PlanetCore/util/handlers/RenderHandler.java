...
public class RenderHandler {
	...
	public static void registerEntityRenders() {
		...
		RenderingRegistry.registerEntityRenderingHandler(NitrogenCoolerEntity.class,manager -> new RenderSnowball<>(manager,ModItems.NITROGEN_COOLER, Minecraft.getMinecraft().getRenderItem()));
	}
