...
public class ItemTool extends Item {
    ...
    protected float relentless;
    /** Total combined attack damage of this item (tool damage + material damage) */
    protected float attackDamage;
    protected float attackSpeed;
    /** The material this tool is made from. */
    protected ModItems.ToolMaterialCustom toolMaterial;

    protected ItemTool(float attackDamageIn, float attackSpeedIn, ModItems.ToolMaterialCustom materialIn, Set<Block> effectiveBlocksIn)
    {
        ...
        this.relentless = materialIn.getRelentless();
    ...
    protected ItemTool(ModItems.ToolMaterialCustom materialIn, Set<Block> effectiveBlocksIn)
    {
