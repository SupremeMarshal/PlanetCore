...
public class JadeBow extends ItemBow
{
    private Item arrow;
    private int damage;
    public JadeBow()
    ...
    {
        return repair.getItem() == ModItems.JADE || super.getIsRepairable(toRepair, repair);
    }
    ...
    {
        if(stack.getItem() instanceof ItemArrow || stack.getItem() == ModItems.DIAMOND_ARROW || stack.getItem() == ModItems.TOPAZ_ARROW || stack.getItem() == ModItems.JADE_ARROW)
        {
            return true;
        }
        return false;
            ...
            if (!itemstack.isEmpty() || flag)
            {
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        if (j > 0) {
                            entityarrow.setDamage(damage + (double) j * 0.5D + 3.5D);
                        }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(net.minecraft.client.resources.I18n.format("Can use up to jade tier arrows."));
