...
public class BrigmaniteBow extends ItemBow
{
    private Item arrow;
    private int damage;
    public BrigmaniteBow()
    {
        this.maxStackSize = 1;
        this.setMaxDamage(1152);
            ...
            if (!itemstack.isEmpty() || flag)
            {
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        entityarrow.setDamage(damage + 9);
                        ...
                        if (j > 0) {
                            entityarrow.setDamage(damage + (double) j * 0.5D + 9.5D);
                        }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(net.minecraft.client.resources.I18n.format("Can use up to brigmanite tier arrows."));
