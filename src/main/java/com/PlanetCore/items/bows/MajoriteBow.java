...
public class MajoriteBow extends ItemBow
{
    private Item arrow;
    private int damage;
    public MajoriteBow()
    ...
    {
        return repair.getItem() == ModItems.MAJORITE || super.getIsRepairable(toRepair, repair);
    }
            ...
            if (!itemstack.isEmpty() || flag)
            {
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        entityarrow.setDamage(damage + 14);
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(net.minecraft.client.resources.I18n.format("§c+14 Damage"));
