...
public class DiamondBow extends ItemBow
{
    ...
    {
        if(stack.getItem() instanceof ItemArrow || stack.getItem() == ModItems.EMERALD_ARROW || stack.getItem() == ModItems.RUBY_ARROW || stack.getItem() == ModItems.SAPPHIRE_ARROW || stack.getItem() == ModItems.DIAMOND_ARROW)
        {
            return true;
        }
        return false;
