...
public class TopazBow extends ItemBow
{
    private Item arrow;
    private int damage;
    public TopazBow()
    ...
    {
        return repair.getItem() == ModItems.TOPAZ || super.getIsRepairable(toRepair, repair);
    }
    ...
    {
        if(stack.getItem() instanceof ItemArrow || stack.getItem() == ModItems.DIAMOND_ARROW || stack.getItem() == ModItems.TOPAZ_ARROW)
        {
            return true;
        }
        return false;
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(net.minecraft.client.resources.I18n.format("Can use up to topaz tier arrows."));
