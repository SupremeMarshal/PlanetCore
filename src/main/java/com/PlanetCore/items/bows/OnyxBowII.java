...
public class OnyxBowII extends ItemBow
{
    private Item arrow;
    private int damage;
    public OnyxBowII()
            ...
            if (!itemstack.isEmpty() || flag)
            {
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        entityarrow.setDamage(damage + 30);
                        ...
                        if (j > 0) {
                            entityarrow.setDamage(damage + (double) j * 0.5D + 13.5D);
                        }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        tooltip.add(net.minecraft.client.resources.I18n.format("Can use up to onyx II tier arrows."));
        tooltip.add(net.minecraft.client.resources.I18n.format("Infinity enchantment don't work with this bow."));
        tooltip.add(net.minecraft.client.resources.I18n.format("§c+30 Damage"));
