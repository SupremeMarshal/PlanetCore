...
public class SapphireBow extends ItemBow
{
    private Item arrow;
    private int damage;
    public SapphireBow()
    ...
    {
        return repair.getItem() == ModItems.SAPPHIRE || super.getIsRepairable(toRepair, repair);
    }
    ...
    {
        if(stack.getItem() instanceof ItemArrow || stack.getItem() == ModItems.EMERALD_ARROW || stack.getItem() == ModItems.RUBY_ARROW || stack.getItem() == ModItems.SAPPHIRE_ARROW)
        {
            return true;
        }
        return false;
