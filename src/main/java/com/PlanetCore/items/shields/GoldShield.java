...
public class GoldShield extends ShieldBase implements IHasModel {
    ...
    {
        return repair.getItem() == Item.getItemFromBlock(ModBlocks.GOLD_BLOCK) ? true : super.getIsRepairable(toRepair, repair);
    }
