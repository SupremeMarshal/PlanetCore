...
public class TinShield extends ItemShield {
    ...
    static {
        ...
        modMap.put(SharedMonsterAttributes.KNOCKBACK_RESISTANCE,
                ...
                new AttributeModifier(KNOCKBACK_RESISTANCE_IRONSHIELD_UUID,
                        ...
                        "Tin Shield knockback resistance", 0.05D, 0));
...
public boolean getIsRepairable(ItemStack toRepair, ItemStack repair)
    {
        return repair.getItem() == Item.getItemFromBlock(ModBlocks.TIN_BLOCK) || super.getIsRepairable(toRepair, repair);
    }
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
        ...
        if (slot==EntityEquipmentSlot.MAINHAND || slot==EntityEquipmentSlot.OFFHAND ) {
            ...
            mods.put(knockback, new AttributeModifier (KNOCKBACK_RESISTANCE_IRONSHIELD_UUID, "Tin Shield knockback resistance", 0.05D, 0));
