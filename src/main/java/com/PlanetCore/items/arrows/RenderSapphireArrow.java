...
public class RenderSapphireArrow<T extends EntitySapphireArrow> extends Render<T> {

    public RenderSapphireArrow(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntitySapphireArrow entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/sapphire_arrow.png");
    }
