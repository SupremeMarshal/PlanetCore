...
public class RenderOnyxArrowIII<T extends EntityOnyxArrowIII> extends Render<T> {

    public RenderOnyxArrowIII(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityOnyxArrowIII entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/onyx_arrow_iii.png");
    }
