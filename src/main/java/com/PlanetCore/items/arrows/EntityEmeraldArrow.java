...
public class EntityEmeraldArrow extends Entity implements IProjectile {
    ...
    public EntityEmeraldArrow.PickupStatus pickupStatus;
    ...
    public EntityEmeraldArrow(World worldIn)
    {
        ...
        this.yTile = -1;
        this.zTile = -1;
        this.pickupStatus = EntityEmeraldArrow.PickupStatus.DISALLOWED;
        this.damage = 2.5D;
    ...
    public EntityEmeraldArrow(World worldIn, EntityLivingBase shooter)
    {
        ...
        {
            this.pickupStatus = EntityEmeraldArrow.PickupStatus.ALLOWED;
        }
    }
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            else
            {
                ...
                {
                    if (this.pickupStatus == EntityEmeraldArrow.PickupStatus.ALLOWED)
                    {
    ...
    public void readEntityFromNBT(NBTTagCompound compound)
    {
        ...
        {
            this.pickupStatus = EntityEmeraldArrow.PickupStatus.getByOrdinal(compound.getByte("pickup"));
        }
        else if (compound.hasKey("player", 99))
        {
            this.pickupStatus = compound.getBoolean("player") ? EntityEmeraldArrow.PickupStatus.ALLOWED : EntityEmeraldArrow.PickupStatus.DISALLOWED;
        }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn)
    {
        ...
        {
            boolean flag = this.pickupStatus == EntityEmeraldArrow.PickupStatus.ALLOWED || this.pickupStatus == EntityEmeraldArrow.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

            if (this.pickupStatus == EntityEmeraldArrow.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
            {
                flag = false;
            }
    ...
    public static enum PickupStatus
    {
        ...
        public static EntityEmeraldArrow.PickupStatus getByOrdinal(int ordinal)
        {
