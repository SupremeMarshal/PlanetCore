...
public class RenderJadeArrow<T extends EntityJadeArrow> extends Render<T> {

    public RenderJadeArrow(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityJadeArrow entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/jade_arrow.png");
    }
