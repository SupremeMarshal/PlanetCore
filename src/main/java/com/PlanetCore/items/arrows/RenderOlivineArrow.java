...
public class RenderOlivineArrow<T extends EntityOlivineArrow> extends Render<T> {

    public RenderOlivineArrow(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityOlivineArrow entity)
    {
