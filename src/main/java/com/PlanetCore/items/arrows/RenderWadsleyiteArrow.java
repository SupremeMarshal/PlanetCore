...
public class RenderWadsleyiteArrow<T extends EntityWadsleyiteArrow> extends Render<T> {

    public RenderWadsleyiteArrow(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityWadsleyiteArrow entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/wadsleyite_arrow.png");
    }
