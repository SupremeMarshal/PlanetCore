...
public class RenderOnyxArrowIV<T extends EntityOnyxArrowIV> extends Render<T> {

    public RenderOnyxArrowIV(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityOnyxArrowIV entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/onyx_arrow_iv.png");
    }
