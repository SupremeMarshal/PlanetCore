...
public class RenderOnyxArrowV<T extends EntityOnyxArrowV> extends Render<T> {

    public RenderOnyxArrowV(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityOnyxArrowV entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/onyx_arrow_v.png");
    }
