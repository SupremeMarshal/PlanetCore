...
public class RenderAmazoniteArrow<T extends EntityAmazoniteArrow> extends Render<T> {

    public RenderAmazoniteArrow(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityAmazoniteArrow entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/amazonite_arrow.png");
    }
