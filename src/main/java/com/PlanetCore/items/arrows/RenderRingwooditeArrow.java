...
public class RenderRingwooditeArrow<T extends EntityRingwooditeArrow> extends Render<T> {

    public RenderRingwooditeArrow(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityRingwooditeArrow entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/ringwoodite_arrow.png");
    }
