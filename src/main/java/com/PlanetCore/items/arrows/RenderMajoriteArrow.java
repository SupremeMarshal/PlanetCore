...
public class RenderMajoriteArrow<T extends EntityMajoriteArrow> extends Render<T> {

    public RenderMajoriteArrow(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityMajoriteArrow entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/majorite_arrow.png");
    }
