...
public class RenderOnyxArrow<T extends EntityOnyxArrow> extends Render<T> {

    public RenderOnyxArrow(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityOnyxArrow entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/onyx_arrow.png");
    }
