...
public class RenderTopazArrow<T extends EntityTopazArrow> extends Render<T> {
    ...
    protected ResourceLocation getEntityTexture(EntityTopazArrow entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/topaz_arrow.png");
    }
