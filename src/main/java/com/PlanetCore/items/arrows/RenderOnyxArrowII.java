...
public class RenderOnyxArrowII<T extends EntityOnyxArrowII> extends Render<T> {

    public RenderOnyxArrowII(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityOnyxArrowII entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/onyx_arrow_ii.png");
    }
