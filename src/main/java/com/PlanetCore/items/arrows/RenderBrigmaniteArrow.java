...
public class RenderBrigmaniteArrow<T extends EntityBrigmaniteArrow> extends Render<T> {

    public RenderBrigmaniteArrow(RenderManager manager)
    {
        super(manager);
    }

    protected ResourceLocation getEntityTexture(EntityBrigmaniteArrow entity)
    {
        return new ResourceLocation(Reference.MOD_ID + ":textures/entity/arrows/brigmanite_arrow.png");
    }
