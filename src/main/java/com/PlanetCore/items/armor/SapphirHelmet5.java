...
public class SapphirHelmet5 extends ArmorBase

{

	public SapphirHelmet5(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(name, materialIn, renderIndexIn, equipmentSlotIn);
		// TODO Auto-generated constructor stub
	}
    
	public static final UUID MAX_HEALTH_SAPPHIRHELM_UUID = UUID.fromString("da043cbe-e98c-4a14-8bcf-738e96bf49d6");
	public static final UUID KNOCKBACK_RESISTANCE_SAPPHIRHELM_UUID = UUID.fromString("adbf5b34-d36c-4d94-bbd2-fd702395041d");
