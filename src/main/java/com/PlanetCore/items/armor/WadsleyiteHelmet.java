...
public class WadsleyiteHelmet extends ArmorBase

{

	public WadsleyiteHelmet(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    static {
		...
		modMap.put(SharedMonsterAttributes.MAX_HEALTH, new AttributeModifier(MAX_HEALTH_DIAMONDHELM_UUID, "MAX_HEALTH_DIAMONDHELM_UUID", 10, 0));
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.HEAD) {
    		...
    		mods.put(maxhealthplatinumhelm, new AttributeModifier (MAX_HEALTH_DIAMONDHELM_UUID, "MAX_HEALTH_DIAMONDHELM_UUID", 10, 0));
