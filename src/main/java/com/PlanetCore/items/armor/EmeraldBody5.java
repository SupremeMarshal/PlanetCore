...
public class EmeraldBody5 extends ArmorBase

{

	public EmeraldBody5(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(name, materialIn, renderIndexIn, equipmentSlotIn);
		// TODO Auto-generated constructor stub
	}
    
	public static final UUID MAX_HEALTH_EMERALDBODY_UUID = UUID.fromString("d587897a-053f-423c-830d-8e72f568fe08");
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.CHEST) {
    		...
    		mods.put(maxhealth, new AttributeModifier (MAX_HEALTH_EMERALDBODY_UUID, "MAX_HEALTH_EMERALDBODY_UUID", 7, 0));
    	}
    	return mods;
    }
