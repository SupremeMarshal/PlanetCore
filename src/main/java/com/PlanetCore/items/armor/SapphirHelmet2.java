...
public class SapphirHelmet2 extends ArmorBase

{

	public SapphirHelmet2(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(name, materialIn, renderIndexIn, equipmentSlotIn);
		// TODO Auto-generated constructor stub
	}
    
	public static final UUID MAX_HEALTH_SAPPHIRHELM_UUID = UUID.fromString("39ab6639-3c06-4a01-ab25-5ca47c123bcd");
	public static final UUID KNOCKBACK_RESISTANCE_SAPPHIRHELM_UUID = UUID.fromString("23268b9c-1cd9-4790-b603-7f9926838cf9");
    ...
    static {
		...
		modMap.put(SharedMonsterAttributes.MAX_HEALTH, new AttributeModifier(MAX_HEALTH_SAPPHIRHELM_UUID, "MAX_HEALTH_SAPPHIRHELM_UUID", 10, 0));
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.HEAD) {
    		...
    		mods.put(maxhealthplatinumhelm, new AttributeModifier (MAX_HEALTH_SAPPHIRHELM_UUID, "MAX_HEALTH_SAPPHIRHELM_UUID", 10, 0));
