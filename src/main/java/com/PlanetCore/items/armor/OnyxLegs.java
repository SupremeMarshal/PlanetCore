...

{
    ...
    static {
		...
		modMap.put(SharedMonsterAttributes.MAX_HEALTH, new AttributeModifier(MAX_HEALTH_ONYXLEGS_UUID, "MAX_HEALTH_ONYXLEGS_UUID", 20, 0));
		modMap.put(SharedMonsterAttributes.KNOCKBACK_RESISTANCE, new AttributeModifier(KNOCKBACK_RESISTANCE_ONYXLEGS_UUID, "KNOCKBACK_RESISTANCE_ONYXLEGS_UUID", 0.15, 0));
	}
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.LEGS) {
    		...
    		mods.put(maxhealth, new AttributeModifier (MAX_HEALTH_ONYXLEGS_UUID, "MAX_HEALTH_ONYXLEGS_UUID", 20, 0));
    		mods.put(knockback, new AttributeModifier (KNOCKBACK_RESISTANCE_ONYXLEGS_UUID, "KNOCKBACK_RESISTANCE_ONYXLEGS_UUID", 0.15, 0));
    	}
    	return mods;
    }
