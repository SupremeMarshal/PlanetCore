...
public class TitaniumLegs extends ArmorBase

{

	public TitaniumLegs(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.LEGS) {
    		...
    		mods.put(maxhealth, new AttributeModifier (MAX_HEALTH_PLATINUMLEGS_UUID, "MAX_HEALTH_PLATINUMLEGS_UUID", 2, 0));
    		}
    	return mods;
    }
