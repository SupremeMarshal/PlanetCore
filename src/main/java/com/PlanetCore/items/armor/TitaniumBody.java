...
public class TitaniumBody extends ArmorBase

{

	public TitaniumBody(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.CHEST) {
    		...
    		mods.put(maxhealth, new AttributeModifier (MAX_HEALTH_PLATINUMBODY_UUID, "MAX_HEALTH_PLATINUMBODY_UUID", 4, 0));
    	}
    	return mods;
    }
