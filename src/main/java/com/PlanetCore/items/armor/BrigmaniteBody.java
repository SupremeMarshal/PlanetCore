...
public class BrigmaniteBody extends ArmorBase

{

	public BrigmaniteBody(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    static {
		...
		modMap.put(SharedMonsterAttributes.MAX_HEALTH, new AttributeModifier(MAX_HEALTH_DIAMONDBODY_UUID, "MAX_HEALTH_DIAMONDBODY_UUID", 12, 0));
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.CHEST) {
    		...
    		mods.put(maxhealth, new AttributeModifier (MAX_HEALTH_DIAMONDBODY_UUID, "MAX_HEALTH_DIAMONDBODY_UUID", 12, 0));
