...
public class WadsleyiteBoots extends ArmorBase

{

	public WadsleyiteBoots(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    static {
		...
		modMap.put(SharedMonsterAttributes.MAX_HEALTH, new AttributeModifier(MAX_HEALTH_DIAMONDBOOTS_UUID, "MAX_HEALTH_DIAMONDBOOTS_UUID", 10, 0));
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.FEET) {
    		...
    		mods.put(maxhealth, new AttributeModifier (MAX_HEALTH_DIAMONDBOOTS_UUID, "MAX_HEALTH_DIAMONDBOOTS_UUID", 10, 0));
