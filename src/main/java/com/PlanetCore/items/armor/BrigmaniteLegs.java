...
public class BrigmaniteLegs extends ArmorBase

{

	public BrigmaniteLegs(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    static {
		...
		modMap.put(SharedMonsterAttributes.MAX_HEALTH, new AttributeModifier(MAX_HEALTH_DIAMONDLEGS_UUID, "MAX_HEALTH_DIAMONDLEGS_UUID", 12, 0));
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.LEGS) {
    		...
    		mods.put(maxhealth, new AttributeModifier (MAX_HEALTH_DIAMONDLEGS_UUID, "MAX_HEALTH_DIAMONDLEGS_UUID", 12, 0));
