...
public class SilverHelmet extends ArmorBase

{

	public SilverHelmet(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(name, materialIn, renderIndexIn, equipmentSlotIn);
		// TODO Auto-generated constructor stub
	}
    
	public static final UUID MAX_HEALTH_SILVERHELM_UUID = UUID.fromString("95ad1615-9a53-44f1-b52c-3cdad3fb50d1");
