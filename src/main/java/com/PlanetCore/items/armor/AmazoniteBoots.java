...

{
    ...
    static {
		...
		modMap.put(SharedMonsterAttributes.MAX_HEALTH, new AttributeModifier(MAX_HEALTH_AMAZONITEBOOTS_UUID, "MAX_HEALTH_AMAZONITEBOOTS_UUID", 16, 0));
    ...
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.FEET) {
    		...
    		mods.put(maxhealth, new AttributeModifier (MAX_HEALTH_AMAZONITEBOOTS_UUID, "MAX_HEALTH_AMAZONITEBOOTS_UUID", 16, 0));
