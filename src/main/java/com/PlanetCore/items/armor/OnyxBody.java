...

{
	...
	public OnyxBody(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    static {
		...
		modMap.put(SharedMonsterAttributes.MAX_HEALTH, new AttributeModifier(MAX_HEALTH_ONYXBODY_UUID, "MAX_HEALTH_ONYXBODY_UUID", 20, 0));
   ...
   @Override
    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slot,
    	...
    	if (slot==EntityEquipmentSlot.CHEST) {
    		...
    		mods.put(maxhealth, new AttributeModifier (MAX_HEALTH_ONYXBODY_UUID, "MAX_HEALTH_ONYXBODY_UUID", 20, 0));
