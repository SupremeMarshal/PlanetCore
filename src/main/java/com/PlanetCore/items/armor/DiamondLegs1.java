...
public class DiamondLegs1 extends ArmorBase

{

	public DiamondLegs1(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
