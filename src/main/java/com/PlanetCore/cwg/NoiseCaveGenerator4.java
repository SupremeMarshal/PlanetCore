...
public class NoiseCaveGenerator4 implements ICubicStructureGenerator {
    //V17
    private IBuilder builder;
    private IBlockState stoneBlock;

    public NoiseCaveGenerator4() {
    }
    ...
    public void generate(World world, CubePrimer cubePrimer, CubePos cubePos) {
        if (this.builder == null) {
            ...
            double transitionConstant2 = 0.4;
        ...
        builder.forEachScaled(start, end, new Vec3i(4, 4, 4), (x, y, z, gradX, gradY, gradZ, value) -> {
            ...
            if (value > 0) {
                if (blockY < -2200) cubePrimer.setBlockState(x, y, z, ModBlocks.TUNGSTEN_LAVA_FLUID.getDefaultState());
