...
public class ImprovedCaveGenerator implements ICubicStructureGenerator {
    ...
    public enum CaveType {
        ...
        CAVE1(Block.getBlockFromName("planetcore:aluminium_supercompact"),0.5, -256.0,64,10000,-10000, 10000, 16, 0),
        CAVE2(Block.getBlockFromName("planetcore:zinc_supercompact"),0.4, -256.0,64,10000,-10000, 10000, 16, 0),
        CAVE3(Block.getBlockFromName("planetcore:lead_supercompact"),0.4, -256.0,64,10000, -10000, 10000, 16, 0),
        CAVE4(Block.getBlockFromName("planetcore:tin_supercompact"),0.3, -256.0,64,10000, -10000, 10000, 16, 0),
        CAVE5(Block.getBlockFromName("planetcore:copper_supercompact"),0.3, -256.0,64,10000,-10000, 10000, 16, 0),
        CAVE6(Block.getBlockFromName("planetcore:iron_supercompact"),0.4, -256.0,64,10000,-10000, 10000, 16, 0),
        CAVE7(Block.getBlockFromName("planetcore:redstone_supercompact"),0.2, -256.0,64,10000, -10000, 10000, 16, 0),
        CAVE8(Block.getBlockFromName("planetcore:silver_supercompact"),0.2, -256.0,64,10000, -10000, 10000, 16, 0),
        CAVE9(Block.getBlockFromName("planetcore:gold_supercompact"),0.1, -256.0,64,10000,-10000, 10000, 16, 0),
        CAVE10(Block.getBlockFromName("planetcore:platinum_supercompact"),0.1, -320.0,64,10000,-10000, 10000, 16, 0),
        CAVE11(Block.getBlockFromName("planetcore:titanium_supercompact"),0.1, -384.0,64,10000, -10000, 10000, 16, 0),
        CAVE12(Block.getBlockFromName("planetcore:uranium_supercompact"),0.1, -448.0,64,10000, -10000, 10000, 16, 0),
        CAVE13(Block.getBlockFromName("planetcore:tungsten_supercompact"),0.1, -512.0,64,10000, -10000, 10000, 16, 0),
        CAVE14(Block.getBlockFromName("planetcore:topaz_supercompact"),0.1, -512.0,64,10000, -10000, 10000, 16, 0),
        CAVE15(Block.getBlockFromName("planetcore:jade_supercompact"),0.1, -512.0,64,10000, -10000, 10000, 16, 0),
        CAVE16(Block.getBlockFromName("planetcore:emerald_supercompact"),0.05, -576.0,64,10000, -10000, 10000, 16, 0),
        CAVE17(Block.getBlockFromName("planetcore:ruby_supercompact"),0.05, -640.0,64,10000, -10000, 10000, 16, 0),
        CAVE18(Block.getBlockFromName("planetcore:sapphire_supercompact"),0.05, -640.0,64,10000, -10000, 10000, 16, 0),
        CAVE19(Block.getBlockFromName("planetcore:diamond_supercompact"),0.05, -704.0,64,10000, -10000, 10000, 16, 0),
        CAVE20(Block.getBlockFromName("planetcore:olivine_supercompact"),0.05, -768.0,64,10000, -10000, 10000, 16, 0),
        CAVE21(Block.getBlockFromName("planetcore:wadsleyite_supercompact"),0.05, -832.0,64,10000, -10000, 10000, 16, 0),
        CAVE22(Block.getBlockFromName("planetcore:ringwoodite_supercompact"),0.05, -896.0,64,10000, -10000, 10000, 16, 0),
        CAVE23(Block.getBlockFromName("planetcore:brigmanite_supercompact"),0.05, -960.0,64,10000, -10000, 10000, 16, 0),
        CAVE24(Block.getBlockFromName("planetcore:majorite_supercompact"),0.05, -1024.0,64,10000, -10000, 10000, 16, 0),
        CAVE25(Block.getBlockFromName("planetcore:amazonite_supercompact"),0.05, -1088.0,64,10000, -10000, 10000, 16, 0),
        CAVE26(Block.getBlockFromName("planetcore:onyx_supercompact"),0.05, -1375.0,64,10000, -10000, 10000, 16, 0);
