...
public class ImprovedCaveGenerator implements ICubicStructureGenerator {
    ...
    public enum CaveType {
        ...
        CAVE1(Block.getBlockFromName("planetcore:aluminium_supercompact"),1.0, -32.0,64,10000,-10000, 10000, 16, 0),
        CAVE2(Block.getBlockFromName("planetcore:zinc_supercompact"),0.4, -32.0,64,10000,-10000, 10000, 16, 0),
        CAVE3(Block.getBlockFromName("planetcore:lead_supercompact"),0.4, -32.0,64,10000, -10000, 10000, 16, 0),
        CAVE4(Block.getBlockFromName("planetcore:tin_supercompact"),0.3, -64.0,64,10000, -10000, 10000, 16, 0),
        CAVE5(Block.getBlockFromName("planetcore:copper_supercompact"),0.3, -64.0,64,10000,-10000, 10000, 16, 0),
        CAVE6(Block.getBlockFromName("planetcore:iron_supercompact"),0.5, -96.0,64,10000,-10000, 10000, 16, 0),
        CAVE7(Block.getBlockFromName("planetcore:redstone_supercompact"),0.2, -128.0,64,10000, -10000, 10000, 16, 0),
        CAVE8(Block.getBlockFromName("planetcore:silver_supercompact"),0.2, -128.0,64,10000, -10000, 10000, 16, 0),
        CAVE9(Block.getBlockFromName("planetcore:gold_supercompact"),0.1, -192.0,64,10000,-10000, 10000, 16, 0),
        CAVE10(Block.getBlockFromName("planetcore:platinum_supercompact"),0.1, -256.0,64,10000,-10000, 10000, 16, 0),
        CAVE11(Block.getBlockFromName("planetcore:titanium_supercompact"),0.1, -320.0,64,10000, -10000, 10000, 16, 0),
        CAVE12(Block.getBlockFromName("planetcore:uranium_supercompact"),0.1, -384.0,64,10000, -10000, 10000, 16, 0),
        CAVE13(Block.getBlockFromName("planetcore:tungsten_supercompact"),0.1, -448.0,64,10000, -10000, 10000, 16, 0),
