...
public class ImprovedCaveGenerator implements ICubicStructureGenerator {
    ...
    public enum CaveType {
        ...
        CAVE8(ModBlocks.GOLD_SUPERCOMPACT,0.02, -30.0,32,10000,-10000, 10000, 64, 64),
        CAVE20(ModBlocks.DIAMOND_SUPERCOMPACT,0.01, -35.0,32,10000, -10000, 10000, 64, 64),
        CAVE28(ModBlocks.EMERALD_SUPERCOMPACT,0.01, -35.0,32,10000, -10000, 10000, 64, 64),
        CAVE29(ModBlocks.LAPIS_SUPERCOMPACT,0.01, -35.0,32,10000, -10000, 10000, 64, 64),
        CAVE9(ModBlocks.TOPAZ_SUPERCOMPACT,0.01, -40.0,32,10000,-10000, 10000, 64, 64),
        CAVE10(ModBlocks.TITANIUM_SUPERCOMPACT,0.02, -40.0,32,10000, -10000, 10000, 64, 64),
        CAVE11(ModBlocks.BORON_SUPERCOMPACT,0.02, -40.0,32,10000, -10000, 10000, 64, 64),
        CAVE12(ModBlocks.LITHIUM_SUPERCOMPACT,0.02, -40.0,32,10000, -10000, 10000, 64, 64),
        CAVE13(ModBlocks.MAGNESIUM_SUPERCOMPACT,0.02, -40.0,32,10000, -10000, 10000, 64, 64),
        CAVE14(ModBlocks.THORIUM_SUPERCOMPACT,0.02, -40.0,32,10000, -10000, 10000, 64, 64),
        CAVE15(ModBlocks.URANIUM_SUPERCOMPACT,0.02, -40.0,32,10000, -10000, 10000, 64, 64),
        CAVE16(ModBlocks.TUNGSTEN_SUPERCOMPACT,0.02, -42.0,32,10000, -10000, 10000, 64, 64),
        CAVE17(ModBlocks.JADE_SUPERCOMPACT,0.01, -44.0,32,10000, -10000, 10000, 64, 64),
        CAVE18(ModBlocks.RUBY_SUPERCOMPACT,0.01, -46.0,32,10000, -10000, 10000, 64, 64),
        CAVE19(ModBlocks.SAPPHIRE_SUPERCOMPACT,0.01, -48.0,32,10000, -10000, 10000, 64, 64),
        CAVE21(ModBlocks.OLIVINE_SUPERCOMPACT,0.01, -50.0,32,10000, -10000, 10000, 64, 64),
        CAVE22(ModBlocks.WADSLEYITE_SUPERCOMPACT,0.01, -52.0,32,10000, -10000, 10000, 64, 64),
        CAVE23(ModBlocks.RINGWOODITE_SUPERCOMPACT,0.01, -54.0,32,10000, -10000, 10000, 64, 64),
        CAVE24(ModBlocks.BRIGMANITE_SUPERCOMPACT,0.01, -56.0,32,10000, -10000, 10000, 64, 64),
        CAVE25(ModBlocks.MAJORITE_SUPERCOMPACT,0.01, -58.0,32,10000, -10000, 10000, 64, 64),
        CAVE26(ModBlocks.AMAZONITE_SUPERCOMPACT,0.01, -60.0,32,10000, -10000, 10000, 64, 64),
        CAVE27(ModBlocks.ONYX_SUPERCOMPACT,0.01, -62.0,32,10000, -10000, 10000, 64, 64);
