...
public class CellNoiseRockCaveGenerator implements ICubicStructureGenerator {
    ...
    public CellNoiseRockCaveGenerator(long seedModifier) {
    ...
    private Supplier<IBlockState> airBlock(int cellX, int cellY, int cellZ, CellCaveType type, int cell, FastRandom rand) {
        ...
        else if (type == CellCaveTypes.PERIDOTITE_CAVE) return () -> ModBlocks.ROCK.getStateFromMeta(3);
        else if (type == CellCaveTypes.GARNET_CAVE) return () -> ModBlocks.ROCK.getStateFromMeta(4);
        else if (type == CellCaveTypes.BRIDGMANITE_CAVE) return () -> ModBlocks.ROCK.getStateFromMeta(6);
        else if (type == CellCaveTypes.FERROPERICLASE_CAVE) return () -> ModBlocks.ROCK.getStateFromMeta(8);
        else if (type == CellCaveTypes.CORESTONE_CAVE) return () -> ModBlocks.ROCK.getStateFromMeta(9);
