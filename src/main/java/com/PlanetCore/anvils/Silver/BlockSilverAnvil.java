...
public class BlockSilverAnvil extends BlockFalling {
    ...
    public static IBlockState damage(IBlockState state) {
        ...
        if (block == ModAnvils.blockSilverAnvil) {
            return ModAnvils.blockSilverAnvilChipped.getDefaultState().withProperty(FACING, state.getValue(FACING));
        } else {
            return block == ModAnvils.blockSilverAnvilChipped ? ModAnvils.blockSilverAnvilDamaged.getDefaultState().withProperty(FACING, state.getValue(FACING)) : null;
        }
    }
