...
public class AnvilsHolder {
    ...
    public static BlockGenericAnvil blockSilverAnvil;
    @ObjectHolder("planetcore:silver_anvil_chipped")
    public static BlockGenericAnvil blockSilverAnvilChipped;
    @ObjectHolder("planetcore:silver_anvil_damaged")
    public static BlockGenericAnvil blockSilverAnvilDamaged;
