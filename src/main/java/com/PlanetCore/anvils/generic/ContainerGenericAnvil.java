...
public class ContainerGenericAnvil extends Container {
    ...
    public ContainerGenericAnvil(InventoryPlayer playerInventory, final World worldIn, final BlockPos blockPosIn, EntityPlayer player, final BlockGenericAnvil genericAnvil) {
        ...
        this.enchantability = Math.max(genericAnvil.properties.enchantability, 0.001D);
        ...
        this.addSlotToContainer(new Slot(this.outputSlot, 2, 134, 47) {
            ...
            public ItemStack onTake(EntityPlayer playerIn, @Nonnull ItemStack stack) {
                ...
                double breakChance = this.getBreakChance(playerIn, stack);
                ...
                if (!playerIn.capabilities.isCreativeMode && (!worldIn.isRemote && iblockstate.getBlock() instanceof BlockGenericAnvil && (double)playerIn.getRNG().nextFloat() < breakChance || breakChance == -1.0D)) {
            ...
            public double getBreakChance(EntityPlayer playerIn, ItemStack stack) {
                return genericAnvil.properties.enchantability == -1.0D ? -1.0D : (double)ForgeHooks.onAnvilRepair(playerIn, stack, ContainerGenericAnvil.this.inputSlots.getStackInSlot(0), ContainerGenericAnvil.this.inputSlots.getStackInSlot(1)) / ContainerGenericAnvil.this.durMultiplier;
            }
        });
    ...
    public void updateRepairOutput() {
        ...
        if (itemstack.isEmpty()) {
            ...
            this.maximumCost = (int)((double)this.maximumCost / this.enchantability);
            ...
            if (!itemstack1.isEmpty()) {
                ...
                if (k != i) {
                    i2 = (int)((double)i2 * (1.0D + 1.0D / this.enchantability));
                }
