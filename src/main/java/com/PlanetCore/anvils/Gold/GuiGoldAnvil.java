...
import com.PlanetCore.anvils.Silver.ContainerSilverAnvil;
...
public class GuiGoldAnvil extends GuiContainer implements IContainerListener {
    private static final ResourceLocation anvilResource = new ResourceLocation("planetcore", "textures/gui/gold_anvil.png");
