...
public class ContainerTungstenFurnace extends Container
{
    private final IInventory tileFurnace;
    private int cookTime, totalCookTime, burnTime, currentBurnTime;

    public ContainerTungstenFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;

        this.addSlotToContainer(new Slot(furnaceInventory, 0, 25, 11));
        this.addSlotToContainer(new Slot(furnaceInventory, 1, 68, 11));
        this.addSlotToContainer(new SlotTungstenFurnaceFuel(furnaceInventory, 2, 10, 45));
