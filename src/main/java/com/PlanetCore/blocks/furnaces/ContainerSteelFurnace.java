...
public class ContainerSteelFurnace extends Container
{
    ...
    public ContainerSteelFurnace(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;

        this.addSlotToContainer(new Slot(furnaceInventory, 0, 25, 11));
        this.addSlotToContainer(new Slot(furnaceInventory, 1, 68, 11));
        this.addSlotToContainer(new SlotSteelFurnaceFuel(furnaceInventory, 2, 46, 45));
