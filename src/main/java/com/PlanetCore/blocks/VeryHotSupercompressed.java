...
public class VeryHotSupercompressed extends BlockBase {
	public final PlanetMaterial planetMaterial;
	public final PlanetHardness planetHardness;
	public final PlanetExp planetExp;
	public VeryHotSupercompressed(String name, Material material, PlanetMaterial planetMaterial, PlanetHardness planetHardness, PlanetExp planetExp) {
		super(name, material);
	...
	{
		if (this == ModBlocks.VERY_HOT_SUPERCOMPRESSED_LAPIS) return 36 + random.nextInt(5);
		else if (this == ModBlocks.VERY_HOT_SUPERCOMPRESSED_REDSTONE) return 36 + random.nextInt(2);
		else return 9;
	}

	@Override
	public int quantityDroppedWithBonus(int fortune, Random random) {
		if (this == ModBlocks.VERY_HOT_SUPERCOMPRESSED_REDSTONE)
		{
	...
	public int damageDropped(IBlockState state) {
		if (this == ModBlocks.VERY_HOT_SUPERCOMPRESSED_LAPIS) {
