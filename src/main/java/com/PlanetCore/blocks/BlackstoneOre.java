...
public class BlackstoneOre extends BlockBase implements IMetaName
{
	public static final PropertyEnum<BlackstoneOre.EnumType> VARIANT = PropertyEnum.create("variant", BlackstoneOre.EnumType.class);

	public BlackstoneOre(String name, Material material) {
	...
	{
		if (this == ModBlocks.BLACKSTONE.getStateFromMeta(4)) return 4 + random.nextInt(5);
		else if (this == ModBlocks.BLACKSTONE.getStateFromMeta(3)) return 4 + random.nextInt(2);
		else return 1;
	}
	@Override
	...
	{
		return this.getDefaultState().withProperty(VARIANT, BlackstoneOre.EnumType.byMetadata(meta));
	}
	...
	public enum EnumType implements IStringSerializable
	{
		...
		private static final BlackstoneOre.EnumType[] META_LOOKUP = new BlackstoneOre.EnumType[] {COAL, IRON, SULFUR, REDSTONE, LAPIS, DIAMOND, EMERALD, TITANIUM, URANIUM};
		...
		static {
			for(EnumType Blackstone$enumtype : values())
			{
				META_LOOKUP[Blackstone$enumtype.getMeta()] = Blackstone$enumtype;
			}
		}
	}
	...
	{
		return BlackstoneOre.EnumType.values()[stack.getItemDamage()].getName();
	}
