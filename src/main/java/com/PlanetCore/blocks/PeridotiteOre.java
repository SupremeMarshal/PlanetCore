...
public class PeridotiteOre extends BlockBase implements IMetaName
{
	public static final PropertyEnum<PeridotiteOre.EnumType> VARIANT = PropertyEnum.create("variant", PeridotiteOre.EnumType.class);

	public PeridotiteOre(String name, Material material) {
	...
	public void getSubBlocks(CreativeTabs itemIn, NonNullList<ItemStack> items) {
		for (PeridotiteOre.EnumType Blackstone$enumtype : PeridotiteOre.EnumType.values()) {
	...
	{
		return this.getDefaultState().withProperty(VARIANT, PeridotiteOre.EnumType.byMetadata(meta));
	}
	...
	public enum EnumType implements IStringSerializable
	{
		...
		private static final PeridotiteOre.EnumType[] META_LOOKUP = new PeridotiteOre.EnumType[] {COAL, IRON, SULFUR, REDSTONE, LAPIS, DIAMOND, EMERALD, TITANIUM, URANIUM, TUNGSTEN, RUBY, SAPPHIRE};
	...
	{
		return PeridotiteOre.EnumType.values()[stack.getItemDamage()].getName();
	}
