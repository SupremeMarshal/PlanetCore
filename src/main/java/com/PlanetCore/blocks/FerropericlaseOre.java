...
public class FerropericlaseOre extends BlockBase implements IMetaName
{
	...
	{
		if (this == ModBlocks.FERROPERICLASE.getStateFromMeta(4)) return 4 + random.nextInt(5);
		else if (this == ModBlocks.FERROPERICLASE.getStateFromMeta(3)) return 4 + random.nextInt(2);
		else return 1;
	}
	@Override
