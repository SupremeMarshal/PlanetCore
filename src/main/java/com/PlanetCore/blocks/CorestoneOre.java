...
public class CorestoneOre extends BlockBase implements IMetaName
{

	public static final PropertyEnum<CorestoneOre.EnumType> VARIANT = PropertyEnum.create("variant", CorestoneOre.EnumType.class);

	public CorestoneOre(String name, Material material) {
	...
	{
		if (this == ModBlocks.CORESTONE.getStateFromMeta(4).getBlock()) return 4 + random.nextInt(5);
		else if (this == ModBlocks.CORESTONE.getStateFromMeta(3).getBlock()) return 4 + random.nextInt(2);
		else return 1;
	}
	@Override
	...
	public void getSubBlocks(CreativeTabs itemIn, NonNullList<ItemStack> items) {
		for (CorestoneOre.EnumType Blackstone$enumtype : CorestoneOre.EnumType.values()) {
	...
	{
		return this.getDefaultState().withProperty(VARIANT, CorestoneOre.EnumType.byMetadata(meta));
	}
	...
	public enum EnumType implements IStringSerializable
	{
		...
		private static final CorestoneOre.EnumType[] META_LOOKUP = new CorestoneOre.EnumType[] {COAL, IRON, SULFUR, REDSTONE, LAPIS, DIAMOND, EMERALD, TITANIUM, URANIUM, TUNGSTEN, RUBY, SAPPHIRE, MAJORITE, AMAZONITE, ONYX, PAINITE};
	...
	{
		return CorestoneOre.EnumType.values()[stack.getItemDamage()].getName();
	}
