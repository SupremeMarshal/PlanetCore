...
public class GemBase_compact extends BlockBase
{

	public GemBase_compact(String name, Material material) {
		super(name, material);
...
/*
	...
	public Item getItemDropped(IBlockState state, Random random, int l) {
		...
		if (block == ModBlocks.HARDROCK_EMERALD_COMPACT || block == ModBlocks.DEEPROCK_EMERALD || block == ModBlocks.CRUSTROCK_EMERALD || block == ModBlocks.MANTLEROCK_EMERALD || block == ModBlocks.LOWER_MANTLEROCK_EMERALD) {
